    ...
    <script type="text/javascript">
        $(function () {
            ...
            $("#btnSearch").click(function () {
                var tagId = '';
                if ($("#form-field-select-4").val() != '0') {
                    tagId = $("#form-field-select-4").val();
                }else if ($("#form-field-select-3").val() != '0') {
                        ...
                        <div class="widget-body">
                            <div class="widget-main">
                                <div>
                                    ...
                                    四级标签：
                                    <select class="width-16 chosen-select" id="form-field-select-4"
                                           onchange="onForChange()" >
                                        <%--<option value="">&nbsp;</option>--%>
                                        <option value="0">待选择上级标签</option>
                                    </select>
                                    <button class="btn btn-sm btn-info"
                                            style="width: 80px;margin-left: 20px;" id="btnSearch">查 询
                                    </button>
                                </div>
                            </div>
                        </div>
