!function (e) {
    ...
    function f(e, t, a, i) {
        ...
        function h(e, n, t, r) {
            var a = r ? "" : w.classPrefix, i = '<span class="' + a, o = t ? "" : "</span>";
            return i += e + '">', i + n + o
        }
        ...
        function v(e, t) {
            var r = e.cN ? h(e.cN, "", !0) : "";
            e.rB ? (k += r, B = "") : e.eB ? (k += n(t) + r, B = "") : (k += r, B = t), L = Object.create(e, {parent: {value: L}})
        }
    ...
    var w = {classPrefix: "hljs-", tabReplace: null, useBR: !1, languages: void 0}, x = {}, R = {};
...
hljs.registerLanguage("cpp", function (t) {
    ...
    return {
        ...
        }, {cN: "number", b: "\\b(\\d+(\\.\\d*)?|\\.\\d+)(u|U|l|L|ul|UL|f|F)"}, t.CNM, {
            cN: "preprocessor",
            b: "#",
            e: "$",
...
hljs.registerLanguage("php", function (e) {
    ...
    return {
        ...
        c: [e.CLCM, e.HCM, e.C("/\\*", "\\*/", {
            ...
            eE: !0,
            i: "\\$|\\[|%",
            c: [e.UTM, {cN: "params", b: "\\(", e: "\\)", c: ["self", c, e.CBCM, i, n]}]
        }, {
            cN: "class",
            bK: "class interface",
            e: "{",
...
hljs.registerLanguage("perl", function (e) {
    ...
    }, i = e.C("^(__END__|__DATA__)", "\\n$", {r: 5}), o = [e.BE, r, n], a = [n, e.HCM, i, e.C("^\\=\\w", "\\=cut", {eW: !0}), s, {
        cN: "string",
        c: o,
