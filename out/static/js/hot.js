...
function onClick() {
    ...
    var id4 = $("#form-field-select-4").val();
    //alert(city);
    ...
    if (0 == $("#form-field-select-2").val() && 0 == $("#form-field-select-3").val() && 0 == $("#form-field-select-4").val()) {
        var id = id1;
    } else if (0 == $("#form-field-select-3").val() && 0 == $("#form-field-select-4").val()) {
        var id = id2;
    } else if(0 == $("#form-field-select-4").val()){
        var id = id3;
    }else{
    	var id = id4;
    }
...
function heatValueCallback(r) {
    //alert(JSON.stringify(r.data)+"chart");
    var type = r['type'];
    var data = r['data'];
    var success = r['success'];
