...
define("echarts/config", [], function () {
    ...
    var t = e("./config"), n = e("./tool/env"), r = e("./tool/event"), i = e("./tool/util"), s = e("./tool/vector"), o = e("./tool/matrix"), u = t.EVENT, a = e("./mixin/Eventful"), f = ["resize", "click", "dblclick", "mousewheel", "mousemove", "mouseout", "mouseup", "mousedown", "touchstart", "touchend", "touchmove"], l = {
        resize: function (e) {
    ...
    return a.prototype = {
        type: i.CHART_TYPE_ISLAND, _combine: function (t, n) {
            ...
            var t = s.get(e, "name"), n = s.get(e, "value"), i = s.get(e, "series") != null ? s.get(e, "series").name : "", o = this.getFont(this.option.island.textStyle), u = {
    ...
    return h.prototype = {
        type: o.CHART_TYPE_FUNNEL, _buildShape: function () {
            ...
            if (o === 0)return;
            var c = this._buildFunnelCase(e), h = n.gap, p = o > 1 ? (i.height - (o - 1) * h) / o : i.height, d, v = i.y, m = n.sort === "descending" ? this._getItemWidth(e, u[0].value) : a.parsePercent(n.minSize, i.width), g = n.sort === "descending" ? 1 : 0, y = i.centerX, b = [[y - m / 2 - (m === 0 ? 0 : 10), v - (m === 0 ? 10 : 5)], [y + m / 2 + (m === 0 ? 0 : 10), v - (m === 0 ? 10 : 5)]];
            ...
            var f = this.series[e], c = f.data[t], h = [c, f], p = this.deepMerge(h, "itemStyle.normal") || {}, d = this.deepMerge(h, "itemStyle.emphasis") || {}, v = this.getItemStyleColor(p.color, e, t, c) || n, m = this.getItemStyleColor(d.color, e, t, c) || (typeof v == "string" ? l.lift(v, -0.2) : v), g = {
                zlevel: this._zlevelBase,
    ...
    return p.prototype = {
        constructor: p, type: a.CHART_TYPE_FORCE, _init: function () {
            ...
            for (var s = 0; s < r; s++) {
                var a = t.nodes[s], c = a.data, h = new u({
                    style: {x: 0, y: 0},
            ...
            for (var r = 0; r < n; r++) {
                var i = t.edges[r], o = i.data, a = i.node1, c = i.node2, h = new s({
                    style: {
                        ...
                        yEnd: 0,
                        lineWidth: 1
                    }, clickable: this.query(e, "clickable"), highlightStyle: {}
                });
