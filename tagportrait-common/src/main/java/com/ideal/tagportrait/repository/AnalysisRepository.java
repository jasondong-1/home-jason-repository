...
public interface AnalysisRepository extends JpaRepository<Tag, Long> {
    @Query(value = "SELECT a.name,o.tag_num,o.percent FROM tb_analysis o,tb_area a,tb_tag b WHERE o.area_id=a.id AND o.tag_id=b.id AND tag_id=?1", nativeQuery = true)
